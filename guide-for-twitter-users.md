...
2025年に、公式で「保存（Saved Posts / ブックマーク）」が入りました。
...
### Chat Requests（DMスパム対策）

知らない相手からのDMは「Chat Requests（リクエスト）」側に分けて受け取り、許可／拒否できるようになりました。スパム対策として覚えておくと楽です。

## 友達を見つける

公式アプリで「友達を見つける」機能が使えるようになりました。移住・誘導というより、「すでに知っている人を探す」ための機能です。
