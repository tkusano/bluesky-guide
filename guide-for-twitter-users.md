...
なお、ドメインを取得して設定するのはそれなりに知識がいります。そのためにBluesky社経由でドメインの利用権を取得し、設定をBluesky社に任せることもできます。これは有料ですが、Bluesky社の現時点での唯一の収入源です。英語ですが詳しくは [Purchase and Manage Domains Directly Through Bluesky](https://bsky.social/about/blog/7-05-2023-namecheap)を見てください。
...
さらには、不本意な引用があった場合はそれを取り消させる（剥がす）こともできます。
